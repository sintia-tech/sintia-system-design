  ...
  group('SintiaButton', () {
    testWidgets('renders label text', (tester) async {
      await tester.pumpWidget(
        buildTestApp(SintiaButton(onPressed: () async {}, label: 'Press me')),
      );
    ...
    testWidgets('calls onPressed when tapped', (tester) async {
      ...
      await tester.pumpWidget(
        buildTestApp(
          SintiaButton(onPressed: () async => called = true, label: 'Tap'),
        ),
      );
    ...
    testWidgets('is disabled when onPressed is null', (tester) async {
      await tester.pumpWidget(
        buildTestApp(const SintiaButton(onPressed: null, label: 'Disabled')),
      );
